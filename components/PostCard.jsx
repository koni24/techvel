...
const PostCard = ({ post }) => {
  ...
  return (
    <div className="mb-8 rounded-lg bg-white p-0 pb-12 shadow-lg lg:p-8">
      ...
      <h1 className="mb-8 cursor-pointer text-center text-3xl font-semibold transition duration-100 hover:text-purple-700">
      ...
      <div className="mb-8 block w-full items-center justify-center text-center lg:flex">
        <div className="mb-4 mr-8 flex w-full items-center justify-center lg:mb-0 lg:w-auto">
          <img
            ...
            height="30px"
            width="30px"
            className="full rounded align-middle"
        ...
        <div className="text-fray-700 font-medium">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="mr-2 inline h-6 w-6 text-purple-700"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
